...
json.user do
  ...
  json.metro_code @user.metro_code if @user.metro_code 
  json.device_id @user.device_id if @user.device_id
  json.notifications_permission_state @user.notifications_permission_state if @user.notifications_permission_state
